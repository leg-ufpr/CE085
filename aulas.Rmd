...
**Semana 2**
  ...
  - Idéias: propriedades de estimadores, não-viés, consistência, distribuição e eficiência.
  - Consolidação dos conceitos apresentados. 
  - Exemplos baseados em simulação das propriedades apresentadas.
  
**Semana 3**

  - Revisão geral e formalização matemática. 
  - Revisão geral e formalização matemática. 
  - Revisão geral e formalização matemática.
